# knowledge-curator Specification

## Purpose
Define a bounded, human-controlled review workflow that keeps career knowledge evidence-linked,
semantically coherent, policy-safe, and auditable without granting AI canonical admission authority.
