# output-career-publisher Specification

## Purpose
Define a scalable destination-neutral publication parent that validates exact inputs, discovers leaf
skills, obtains per-destination confirmation, and aggregates honest results without handling vendor
credentials or APIs.
