# input-work-evidence-explorer Specification

## Purpose
Define a safe, profession-neutral workflow for turning an explicitly authorised body of work into
evidence-linked career knowledge proposals while preserving scope, attribution, privacy, and human
admission authority.
