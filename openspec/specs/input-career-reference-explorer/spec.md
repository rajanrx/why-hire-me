# input-career-reference-explorer Specification

## Purpose
Define a bounded, provenance-rich workflow for turning authorised portfolios, publications,
credentials, professional profiles, and other references into reviewable career knowledge without
overstating publisher authority, subject identity, or verification.
