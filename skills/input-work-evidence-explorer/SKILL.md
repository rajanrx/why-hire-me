...
First inventory the bounded work and propose the most informative artefacts for review. Then inspect
only the agreed high-value subset. Use role-neutral lenses:
...
outcomes require focused attribution questions. Never reproduce more proprietary content than is
necessary to support a private observation.
